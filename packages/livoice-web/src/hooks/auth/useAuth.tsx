...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const canEditProject = useMemo(() => canEditProjectData(user), [user]);
  ...
  const contextValue = useMemo(
    () => ({
      ...
      canEditProjectData: (userOrSession?: ExtendedSession | null) => canEditProjectData(userOrSession ?? user),
    ...
    [user, isLoadingAuth, canAdmin, canEditOrg, canEditProject]
  );
